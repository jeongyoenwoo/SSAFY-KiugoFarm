...
<!--왼쪽 이동 버튼-->
    ...
    <div v-if="currentPage === 2" class="flex flex-col justify-center items-center">
      ...
      <span class="mt-5 font-bold font-Notosans text-4xl text-center">농작물을 키울 장소의<br>온도를 알려주세요</span>
    ...
    <div v-if="currentPage === 4" class="flex flex-col justify-center items-center">
      ...
      <span class="mt-5 font-bold font-Notosans text-4xl text-center">농작물을 키울 장소의<br>하루 평균적인 햇빛 노출량은?</span>
    ...
    <div v-if="currentPage === 6" class="flex flex-col justify-center items-center">
      ...
      <span class="mt-5 font-bold font-Notosans text-4xl text-center">농작물을 키울 장소의<br>습도는 어느 정도인가요?</span>
    ...
    if (response.status === 200) {
      ...
      router.push({
        ...
        state: { // params가 state로 바뀌었다.
          result: JSON.stringify(response.data.recommended_crop)
        },
      });
